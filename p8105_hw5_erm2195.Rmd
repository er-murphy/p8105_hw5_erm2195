...
Loading the `tidyverse`, `broom`, and `viridis` libraries for later use.
...
sim_power_results |> 
  ...
  geom_line(alpha = .5) +
  labs(
    title = "Proportion of Samples Rejecting the Null at Different MU Values",
    x = "True μ",
